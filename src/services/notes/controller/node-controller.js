...
export const createNote = async (req, res, next) => {
 ...
 const responseData = { noteId: note.id };
 return response(res, 201, 'Catatan berhasil ditambahkan', responseData )
};
...
export const editNoteById = async (req, res, next) => {
  try {
    ...
    const updatedNote = await NoteRepositories.editNote({ id, title, body, tags });
